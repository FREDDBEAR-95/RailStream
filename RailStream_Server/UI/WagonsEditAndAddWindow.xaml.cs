...
namespace RailStream_Server
{
    public partial class WagonsEditAndAddWindow : Window
    {
        ...
        private int? _wagonId;           // ID Вагона для редактирования

        public WagonsEditAndAddWindow(int? wagonId = null)
        {
        ...
        public void LoadWagonData()
        {
            ...
            var wagon = dataBase.Wagons
                        ...
                        .Include(r => r.Train)
                        .FirstOrDefault(r => r.Id == _wagonId);
        ...
        {
            var wagonsEditingWindow = new WagonsEditingWindow();
        ...
        private bool IsValidWagonNum(string text)
        {
            ...
            if (existWagon != null && existWagon.Id != _wagonId)
            {
                return false;
            }
            if (text.Length > 4)
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_wagonId != null)
            {
                var wagon = dataBase.Wagons.FirstOrDefault(r => r.Id == _wagonId);
